...
with cte as
        ...
        group by year_id, month_id, to_char(order_date, 'MON'))
select y04.mon, round(abs(y04.avg_sales_per_month - y05.avg_sales_per_month)::decimal,2) as diff
from cte y04
join cte y05 on y04.mon = y05.mon
where y04.year_id = 2004
and y05.year_id = 2005
order by y04.month_id;
